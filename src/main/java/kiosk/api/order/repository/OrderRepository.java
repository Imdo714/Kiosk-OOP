...
public interface OrderRepository extends JpaRepository<OrderEntity, Long> {
    ...
    @Query("SELECT new kiosk.api.order.domain.dto.request.OrderDTO(o.orderId, o.orderPrice, o.orderQuantity, o.orderDate) FROM OrderEntity o WHERE o.orderDate >= :start AND o.orderDate < :end")
